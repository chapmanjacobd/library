...
with freeze_time("1980-01-01 00:00:01", tz_offset=8) as clock:

    @pytest.mark.parametrize(
        "args,stdout",
        [
            (["October 2007 3pm"], "2007-10-01T15:00:00\n"),
            (["-U", "October 2007 3pm UTC"], "1191193200\n"),
            (["-U", "October 2007 3pm"], "1191193200\n"),
            (["--from-unix", "1724604514"], "2024-08-26T08:48:34\n"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (["--from-unix", "1724604514", "-tz", "Asia/Hong_Kong"], "08:48:34\n"),
            (["--from-unix", "1724604514", "-tz", "UTC"], "00:48:34\n"),
            (["-u", "-U", "1724597488"], "82288\n"),
        ],
    )
